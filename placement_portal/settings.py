...
SECRET_KEY = 'zf_nd!$u*=zj_7g+=ftlv-=y*60&1$67$oja8vm%=m96+s_y$#'
...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = config('hima******9')
SERVER_EMAIL = config('hima*****9')
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_PORT = 587
EMAIL_HOST_USER = config('hima*****9')
EMAIL_HOST_PASSWORD = config('xyz')
